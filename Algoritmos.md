...
while INICIO:
    tempo_atividade = 0  # simulando contador
    while tempo_atividade < 10:
        print("Analise as opções do Ponto de Partida (Quadro 1A - Folha 1 - Centro)")
        print("Escolha um tema: Computação em nuvem, Inteligência Artificial, Banco de dados")
        ...
        # Verifica se atingiu o quadro final antes do tempo
        ...
        tempo_atividade += 1  # incremento simulando o passar do tempo
...
class JogoRamificacoes
{
    static void Main()
    {
        ...
        {
            Console.WriteLine("Analise as opções do Ponto de Partida (Quadro 1A - Folha 1 - Centro)");
            Console.WriteLine("Escolha um tema: Computação em nuvem, Inteligência Artificial, Banco de dados");
